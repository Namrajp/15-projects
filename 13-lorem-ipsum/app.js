...
form.addEventListener("submit", function (e) {
  ...
  //   console.log(isNaN(value)); // black color means its a string
  // no input will return NAN so, parseInt and input a number is must
  //   console.log(typeof val);
  // empty
  // -1
  // >9   // if any three , display 1 paragraph
